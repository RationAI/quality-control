...
| ![Focused image](data/focus_A.png) | ![partially blurred image](data/focus_B.png) | ![blurred image](data/focus_C.png) |
|:----------------------------------:|:--------------------------------------------:|:----------------------------------:|
...
| ![Focused image](data/focus_A_output.png) | ![Partially blurred image](data/focus_B_output.png) | ![Blurred image](data/focus_C_output.png) |
|:-----------------------------------------:|:---------------------------------------------------:|:-----------------------------------------:|
